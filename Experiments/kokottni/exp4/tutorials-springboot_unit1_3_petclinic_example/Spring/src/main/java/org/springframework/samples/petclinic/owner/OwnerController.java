...
class OwnerController {
    ...
    public Optional<Owners> updateOwner(@PathVariable("ownerId") int id){
        ownersRepository.getOne(id).setFirstName("Shawty");
        Optional<Owners> changed = ownersRepository.findById(1);
        return changed;
    }
}
