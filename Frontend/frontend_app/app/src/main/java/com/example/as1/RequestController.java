...
//    public void makeJsonObjReq(String URL_JSON_OBJECT, Context context){
...
//     */
//
//    public void makeJSONPostRequest(String URL_JSON_OBJECT, Object passIn, Context context) {
//
//        // Convert input to JSONObject
//        JSONObject objectBody = new JSONObject();
//        try {
//           objectBody = new JSONObject(passIn.toString());
//
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
...
//
//        // Adding request to request queue
//      //  VolleySingleton.getInstance(context.getApplicationContext()).addToRequestQueue(jsonArrReq);
//    }
//
